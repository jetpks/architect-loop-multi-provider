...
claude -p --model claude-sonnet-4-6 \
  ...
  --max-turns 40 \
  < tmp/architect/research/<NN>-<lane>.prompt.md \
  > tmp/architect/research/<NN>-<lane>.md
```
...
Parallelize gathering, never synthesis. Write `artifacts/research/<topic>.md`:
...
Commit the report. Raw findings stay in `tmp/architect/research/` (gitignored).
